    ...
    <section id="contact" className="py-24 px-6 relative z-10">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-300 max-w-2xl mx-auto">{c.description}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-zinc-400 uppercase tracking-wider">{c.emailLabel}</h4>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-zinc-400 uppercase tracking-wider">{c.phoneLabel}</h4>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-zinc-400 uppercase tracking-wider">{c.locationLabel}</h4>
          ...
          >
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-zinc-300 mb-1">{c.formName}</label>
              <input 
                ref={nameRef}
                type="text" 
                id="name" 
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-zinc-300 mb-1">{c.formEmail}</label>
              <input 
                ref={emailRef}
                type="email" 
                id="email" 
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-zinc-300 mb-1">{c.formMessage}</label>
              <textarea 
                ref={messageRef}
                id="message" 
                rows="4"
